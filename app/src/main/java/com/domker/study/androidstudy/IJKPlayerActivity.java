...
public class IJKPlayerActivity extends Activity implements View.OnClickListener {
    ...
    private void init() {
        ...
        if (!isPortrait){
            ...
            vseekbar.setProgress(currentvolume);
        ...
        headring = findViewById(R.id.headring);
        vseekbar = findViewById(R.id.vertical_SeekBar);
        vseekbar.setVisibility(View.INVISIBLE);
    ...
    private void lanscape() {
        ...
        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)btnPlay.getLayoutParams();
        params.addRule(RelativeLayout.LEFT_OF,R.id.headring);
        btnPlay.setLayoutParams(params);
